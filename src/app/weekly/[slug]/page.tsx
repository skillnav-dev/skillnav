        ...
        <nav className="mt-12 grid grid-cols-2 gap-4 border-t border-border/40 pt-8">
          {olderIssue ? (
            <Link
              ...
              className="group flex items-start gap-2 rounded-lg border border-border/60 p-4 transition-colors hover:border-primary/40"
            >
          ...
          {newerIssue ? (
            <Link
              ...
              className="group flex items-end gap-2 rounded-lg border border-border/60 p-4 text-right transition-colors hover:border-primary/40"
            >
              <div>
