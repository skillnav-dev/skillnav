...
import { changeMcpStatus } from "@/app/admin/mcp/actions";

interface McpStatusToggleProps {
  serverId: string;
...
export function McpStatusToggle({
  serverId,
  currentStatus,
}: McpStatusToggleProps) {
  ...
  function handleStatusChange(newStatus: string) {
    ...
    startTransition(async () => {
      const result = await changeMcpStatus(formData);
      if (result.ok) {
