...
以下信息源经过调研，明确不纳入 RSS 自动管线：

#### 英文 Newsletter（信噪比不足）

| 源 | 订阅量 | 命中率 | 排除理由 |
|----|--------|--------|---------|
| The Rundown AI | 200 万+ | ~10-15% | 偏商业决策者，46% 读者是 C-suite，不是开发者 |
| TLDR AI | 92 万+ | ~15-20% | 每日量大，需过滤 80%+ 内容，管线成本高 |
| AlphaSignal | 20 万+ | ~10-15% | 偏 ML 研究和论文，与工具生态交集小 |
| AI Weekly | — | ~0% | 纯宏观社会议题，零工具内容 |
| Superhuman AI | 100 万+ | ~5% | 非开发者受众（大众效率提升），无 RSS |
| The Neuron | 60 万+ | ~5% | 泛 AI 新闻，命中率太低 |
| DataNorth AI | — | ~5% | AI 商业策略，非工具实操 |
| Composio Blog | — | 中等 | 偏自家工具推广，信息质量不稳定 |
| Vibe Sparking AI | — | 高 | Claude Code changelog 有价值但过于细碎，不适合翻译文章 |
| codewithmukesh | 8200+ | ~70% | .NET 生态偏向，改为手动策展（见 2.5） |
